...
namespace MultiLC.Controllers
{
    public class VentasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdVenta,IdUsuario,Descripcion")] Venta venta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdVenta,IdUsuario,Descripcion")] Venta venta)
        {
            if (ModelState.IsValid)
            {
